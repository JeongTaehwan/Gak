...
## 🚩 개막(2026-08-21) 전 체크리스트

지금 화면의 데이터는 **실제 경기가 아니다** — 파이프라인 검증용 표본 10경기다.
개막에 맞춰 실제 데이터를 받을 때 할 일이 있고, 그중 **`season-override: 2024` 삭제**를
잊으면 아무 에러 없이 2년 전 일정만 계속 나온다.
전체 목록은 [CLAUDE.md 상단](CLAUDE.md#-2026-08-21-시즌-개막-전에-반드시-할-일) 참고.
