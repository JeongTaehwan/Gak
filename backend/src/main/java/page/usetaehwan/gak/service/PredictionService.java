...
public class PredictionService {
	 ...
	 *
	 * @throws NoSuchElementException   해당 fixture가 없을 때
	 * @throws IllegalArgumentException 킥오프 이후에 예측을 시도할 때(Prediction.create가 던짐)
	 */
	@Transactional
	public Prediction createPrediction(Long fixtureId, Pick pick) {
		...
		Prediction prediction = Prediction.create(fixture, pick, now);
